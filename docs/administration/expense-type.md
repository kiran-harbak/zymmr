---
title: Setup Expense Types
description: A guide for administrators on defining and managing expense categories for accurate project costing and financial tracking.
head:
  - - meta
    - name: keywords
      content: expense types, project costing, financial categories, administration, zymmr
outline: deep
---
...
| Column           | Description                                                        |
| :--------------- | :----------------------------------------------------------------- |
| **EXPENSE TYPE** | The name of the category (e.g., `Rent`, `Equipment`).              |
| **ACTIONS**      | Icons to **Edit** (pencil) or **Delete** (trash can) the type.     |
